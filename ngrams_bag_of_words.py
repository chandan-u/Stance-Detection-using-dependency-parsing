...
class Features:
    ...
    def getCharcterNgrams(self, n=7):
    ...
    def writeFeatureList(self):
        ...
        train_df.to_csv('timbl_pos_ngrams_train_1.csv',index=False,header=False)
        test_df.to_csv('timbl_pos_ngrams_test_1.csv', index=False, header=False)
