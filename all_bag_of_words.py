...
class Features:
    ...
    def getCharcterNgrams(self, len=7):
        ...
        for tweet in self.trainData[tweets].values:
    ...
    def writeFeatureList(self):
        ...
        train_df.to_csv('timbl_allbag_train_1.csv',index=False,header=False)
        test_df.to_csv('timbl_allbag_test_1.csv', index=False, header=False)
